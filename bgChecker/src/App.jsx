    ...
    <>
      ...
      >
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-slate-300 px-3 py-2 rounded-xl'>
            ...
            <button onClick={()=> setColor("tomato")} className='outline-none px-4 py-1 rounded-xl text-white shadow-lg' style={{backgroundColor:"tomato"}}>Tomato</button>
            <button onClick={()=> setColor("cyan")} className='outline-none px-4 py-1 rounded-xl text-black shadow-lg' style={{backgroundColor:"cyan"}}>Cyan</button>
            <button onClick={()=> setColor("lightgreen")} className='outline-none px-4 py-1 rounded-xl text-black shadow-lg' style={{backgroundColor:"lightgreen"}}>Pista</button>
            <button onClick={()=> setColor("darkblue")} className='outline-none px-4 py-1 rounded-xl text-white shadow-lg' style={{backgroundColor:"darkblue"}}>Deep Blue</button>
          </div>
        </div>
      </div>
    </>
